...
!        WRITE(*,'(a18)') 'Start timestep,'
        CALL asm_marker !Next Kernel

        CALL timestep()

!        WRITE(*,'(a18)') 'Start PdV True,'
        CALL asm_marker !Next Kernel

        CALL PdV(.TRUE.)

!        WRITE(*,'(a18)') 'Start Accelerate,'
        CALL asm_marker !Next Kernel

        CALL accelerate()

!        WRITE(*,'(a18)') 'Start PdV False,'
        CALL asm_marker !Next Kernel

        CALL PdV(.FALSE.)

!        WRITE(*,'(a18)') 'Start Flux Calc,'
        CALL asm_marker !Next Kernel

        CALL flux_calc()

!        WRITE(*,'(a18)') 'Start Advection,'
        CALL asm_marker !Next Kernel

        CALL advection()

!        WRITE(*,'(a18)') 'Start Reset Field,'
        CALL asm_marker !Next Kernel

        CALL reset_field()

!        WRITE(*,'(a18)') 'END Reset Field,'
        CALL asm_marker !Next Kernel
