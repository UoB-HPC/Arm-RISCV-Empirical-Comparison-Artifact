...
gccCompilers=(<path/to/AArch64/gcc9.2> <path/to/AArch64/gcc12.2>)  # Change this
gccCompilerNames=(9.2 12.2) # Change this
fortranCompilers=(<path/to/AArch64/gfortran9.2> <path/to/AArch64/gfortran12.2>) # Change this
gXXCompilers=(<path/to/AArch64/g++9.2> <path/to/AArch64/g++12.2>) # Change this
compilerIndex=0
ROOT_DIR=$PWD
...
ISAname=arm
buildDirName=ARMbuilds
commonCompilerOptions="--static -mtune=cortex-a55 -march=armv8-a+nosimd"
